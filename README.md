...
Cute UI: Pastel color palette with rounded buttons and soft shadows.
...
Bash
git clone https://github.com/spelman-studio/cute-calculator.git
Open the project
...
Created with ❤️ by Spelman Studio.
